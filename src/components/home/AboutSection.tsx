...
export const AboutSection = () => {
  ...
  return (
    <section id="about" className="py-20 bg-wellness-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-wellness-lavender to-wellness-cream rounded-3xl p-1">
              <img 
          ...
          {values.map((value, index) => {
            ...
            return (
              <div key={index} className="text-center group animate-slide-up" style={{animationDelay: `${index * 0.1}s`}}>
                <div className="bg-gradient-to-br from-wellness-sage to-wellness-forest w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
