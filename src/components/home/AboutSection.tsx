      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          <div className="animate-slide-up">
            <h3 className="text-2xl font-bold text-serenity-deep mb-4">Our Story</h3>
            ...
            <Link to="/about">
              <Button className="bg-serenity-sky hover:bg-serenity-deep text-white rounded-xl">
                Read Our Full Story
              </Button>
            </Link>
          </div>
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-serenity-mist to-serenity-ice rounded-3xl p-1">
              <img 
          ...
          {values.map((value, index) => {
            ...
            return (
              <div key={index} className="text-center group animate-slide-up" style={{animationDelay: `${index * 0.1}s`}}>
                <div className="bg-gradient-to-br from-serenity-sky to-serenity-ocean w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                  <Icon className="h-8 w-8 text-white" />
                </div>
                <h4 className="text-lg font-semibold text-serenity-deep mb-2">{value.title}</h4>
